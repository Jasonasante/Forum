...
func SetCookies(w http.ResponseWriter, r *http.Request){
    ...
    cookie := http.Cookie{Name: "Maryland", Value: "Bring a little Maryland magic to your cuppa", Expires: expiration, HttpOnly: true}
    http.SetCookie(w, &cookie)
	fmt.Println("set cookie", cookie)
}

func FetchCookies(w http.ResponseWriter, r *http.Request){
